...
class NormalizedPoint:
    """
    Represents a normalized (x, y) coordinate in 2D Cartesian space.
    """
    ...
    @classmethod
    def colinear(cls, *points: "NormalizedPoint") -> bool:
        """
    ...
    @classmethod
    def slope(cls, a: "NormalizedPoint", b: "NormalizedPoint") -> Tuple[float, float]:
        """
